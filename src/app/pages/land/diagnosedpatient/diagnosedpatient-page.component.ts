...
@Component({
    selector: 'app-diagnosedpatient-page',
    templateUrl: './diagnosedpatient-page.component.html',
    styleUrls: ['./diagnosedpatient-page.component.scss']
})

export class DiagnosedPatientPageComponent implements OnInit, OnDestroy{
