...
export class NodiagnosisComponent implements OnInit, OnDestroy{
  ...
  loadTranslations(){
    ...
    this.geneticTests = [
      ...
      {name: 'Single Gene Tests', checked: false, translation: this.translate.instant("dashboardpatient.Single Gene Tests"), scope: this.translate.instant("geneticTests.SingleScope"), applications: this.translate.instant("geneticTests.SingleApplications"), limitations: this.translate.instant("geneticTests.SingleLimitations")},
      ...
      {name: 'WGS', checked: false, translation: this.translate.instant("dashboardpatient.Whole Genome Sequencing (WGS)"), scope: this.translate.instant("geneticTests.WGSScope"), applications: this.translate.instant("geneticTests.WGSApplications"), limitations: this.translate.instant("geneticTests.WGSLimitations")},
