...
export class NavbarD29Component implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(public translate: TranslateService, private layoutService: LayoutService, private configService: ConfigService, private langService: LangService, private router: Router, private inj: Injector, private apiDx29ServerService: ApiDx29ServerService) {
